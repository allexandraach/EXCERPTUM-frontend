...
const Footer = () => {
    ...
    return (
        <footer className='pl-6 md:px-32 w-full bg-navbar_bg flex shadow-lg items-center justify-between text-navbar_font_color opacity-90 h-32 absolute bottom-0'>
