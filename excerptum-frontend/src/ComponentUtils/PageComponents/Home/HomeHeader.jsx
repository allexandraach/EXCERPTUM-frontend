...
const HomeHeader = () => {
    ...
    return (
        <header className="bg-home_hero_img_1 bg-cover bg-center md:bg-none md:bg-chestnut_brown relative">
            {/* Overlay for small screens */}
            <div className="absolute inset-0 bg-chestnut_brown opacity-80 md:hidden"></div>

            <div className="flex justify-between">
                {/* Text Section */}
                <div className="relative z-10 p-6 text-soft_beige max-w-lg mx-auto md:flex md:flex-col md:justify-evenly md:h-96 md:mx-20 md:p-6 md:pt-0 animate-fadeIn">
                    <Link to="/" className="text-3xl md:text-4xl font-satisfy ml-2 pt-1.5">
                        Excerptum
                    </Link>
                    <p className="mt-6 pl-2 text-lg md:text-xl md:mt-10">
                ...
                <img
                    src="src/images/home/hero_img_1.png"
                    alt="Open Book"
